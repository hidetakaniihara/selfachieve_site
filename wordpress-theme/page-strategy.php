...
<p class="kv-question fu" style="transition-delay:.05s">
     なんでうまくいかないの？
    </p>
...
<p class="kv-sub fu" style="transition-delay:.15s">
     施策の前に、戦略がある。
    </p>
<p class="kv-body fu" style="transition-delay:.2s">
     SEOも広告もSNSも試した。なのに成果が出ない。
     <br/>
     その原因は、
...
<!-- SP スワイプ誘導ヒント -->
<p aria-hidden="true" class="problem-swipe-hint">
    スワイプして確認
   </p>
...
<p class="problem-desc">
      施策は実施しているが、何が効いているのかわからない。費用対効果が見えず、予算を増やすべきか迷っている。
     </p>
</div>
...
<p class="problem-desc">
      SEO、SNS、広告、サイトリニューアル——やることが多すぎて優先順位がつけられない。どれが自社に合っているのかわからない。
     </p>
</div>
...
<p class="problem-desc">
      毎月レポートが届くが、数字の意味がわからない。「やっています」という報告だけで、なぜ成果が出ないかの説明がない。
     </p>
</div>
</div>
...
<p class="problem-resolve-main">
     すべて、私たちが伴走して解決します。
    </p>
<p class="problem-resolve-sub">
     まず、あなたの会社がどこで詰まっているかを確認しましょう。
    </p>
</div>
</div>
</section>
...
<span class="wall-card-header-num">
        01
       </span>
<span class="wall-card-header-sep">
        |
       </span>
<span class="wall-card-header-cat">
        戦略・全体
       </span>
</div>
<p class="wall-card-feeling">
       何が問題かわからない。施策を試しても手応えがない。まず現状を整理したい。
      </p>
<p class="wall-wall-label">
       あなたの壁はこれ！
      </p>
<p class="wall-wall-body">
       戦略ナシに戦術（施策）を走らせてる状態で、立ち返るポイントがなかったり、一貫性がなかったりしている。
      </p>
<p class="wall-tags-label">
       推奨施策はこちら
      </p>
<div class="wall-tags-wrap">
<a class="wall-tag" href="<?php echo esc_url( home_url('/strategy/') ); ?>">
        WEB戦略
       </a>
<a class="wall-tag" href="https://htmlacheive.com/saikatsu_r/" rel="noopener noreferrer" target="_blank">
        採用戦略
       </a>
</div>
</article>
...
<p class="wall-wall-body">
       集客施策の「正解」探しに終始して、顧客があなたを選ぶ「理由」が設計されていない。ただ網を広げるだけの集客になり、お金を浪費する悪循環に陥っている。
      </p>
<p class="wall-tags-label">
       推奨施策はこちら
      </p>
<div class="wall-tags-wrap">
<a class="wall-tag" href="<?php echo esc_url( home_url('/listing/') ); ?>">
        リスティング広告
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/ads/display/') ); ?>">
        ディスプレイ広告
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/seo/') ); ?>">
        SEO対策
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/meo/') ); ?>">
        MEO対策
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/ai-seo/') ); ?>">
        AI検索対策
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/') ); ?>">
        SNSマーケティング
       </a>
</div>
</article>
...
<p class="wall-card-feeling">
       アクセスはあるのに問い合わせが来ない。サイトを見ても離脱してしまう。訪問者を顧客に変えたい。
      </p>
<p class="wall-wall-label">
       あなたの壁はこれ！
      </p>
<p class="wall-wall-body">
       ホームページが単なる「情報の紹介」になっており、顧客の動機に対応する「接客」が機能していない。訪問者の迷いを取り除く設計がないため、検討の土台にすら乗れず、機会損失を続けている。
      </p>
<p class="wall-tags-label">
       推奨施策はこちら
      </p>
<div class="wall-tags-wrap">
<a class="wall-tag" href="<?php echo esc_url( home_url('/website/') ); ?>">
        ホームページ制作
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/website/#grow') ); ?>">
        分析改善
       </a>
</div>
</article>
...
<p class="wall-wall-body">
       「売って終わり」の単発施策ばかりで、購入後のお客様をファンにする仕組みがない。一度きりの関係で終わるため、顧客が資産として積み上がらず、常に新規客を追いかけ続けなければならない状態に陥っている。
      </p>
<p class="wall-tags-label">
       推奨施策はこちら
      </p>
<div class="wall-tags-wrap">
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/line/') ); ?>">
        LINE
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/instagram/') ); ?>">
        Instagram
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/x/') ); ?>">
        X（旧Twitter）
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/youtube/') ); ?>">
        YouTube
       </a>
<a class="wall-tag" href="<?php echo esc_url( home_url('/sns/tiktok/') ); ?>">
        TikTok
       </a>
</div>
</article>
...
<p class="wall-wall-body">
       導入自体が「目的」となり、肝心の業務フロー再設計が置き去りがち。また、適材適所のAI選定と活用ルールがない場合が多く、AIに振り回されるだけで、真の効率化から遠ざかっている。
      </p>
<p class="wall-tags-label">
       推奨施策はこちら
      </p>
<div class="wall-tags-wrap">
<a class="wall-tag" href="<?php echo esc_url( home_url('/ai-automation/') ); ?>">
        AI活用支援
       </a>
</div>
</article>
...
<p class="solution-head-reason-q">
      なぜ？
     </p>
<p class="solution-head-reason-body">
      施策の前に必ず現状把握を行うのは、根拠のない施策が最大のコスト浪費だからです。
     </p>
</div>
</div>
<!-- SP スワイプ誘導ヒント -->
<p aria-hidden="true" class="solution-swipe-hint">
    スワイプして確認
   </p>
<div class="solution-items">
<!-- STEP 01 -->
<div class="solution-item fu">
<div aria-hidden="true" class="solution-item-num">
      01
     </div>
<div class="solution-item-body">
<span class="solution-item-step">
       STEP 01
      </span>
...
<p class="solution-item-desc">
       GA4・広告データ・競合調査をもとに、現状を数値で可視化します。
       <strong>
        「感覚」ではなく「データ」で現在地を確認
       </strong>
       します。どこで詰まっているかを客観的に把握することが、戦略設計の出発点です。
      </p>
</div>
</div>
<!-- STEP 02 -->
...
<p class="solution-item-desc">
       分析結果から「集客」「転換」「リピート」のどこに問題があるかを特定します。症状（問い合わせが少ない）ではなく、
       <strong>
        根本原因（ファネルのどこが詰まっているか）を明確に
       </strong>
       します。
      </p>
</div>
...
<p class="solution-item-desc">
       課題に合わせた施策の組み合わせを設計します。
       <strong>
        SEO・広告・SNS・サイト改善など、各施策の役割を明確にし、優先順位と予算配分を決めます
       </strong>
       。必要ならビジネスモデルの見直しも行います。
      </p>
</div>
</div>
<!-- STEP 04 -->
...
<p class="solution-item-desc">
       戦略を渡して終わりではありません。施策の実行と効果測定を継続し、データをもとに改善を積み重ねます。
       <strong>
        「やりっぱなし」ではなく、成果が出るまで伴走
       </strong>
       します。
      </p>
</div>
...
<a class="view-all" href="<?php echo esc_url( home_url('/voice/') ); ?>" style="font-size:16px;color:#ffffff;border-bottom-color:#ffffff;">
      支援先のお客様の声を見る
     </a>
</div>
</div>
<!-- SP スワイプ誘導ヒント -->
<p aria-hidden="true" class="case-swipe-hint">
    スワイプして確認
   </p>
<div class="case-grid">
<div class="case-card fu">
<p class="case-industry">
      医療 / 整骨院
     </p>
<p class="case-title">
      「集客できているのに
...
<p class="case-body">
      ...
      。サイト構造の問題を特定し、LPの改善と問い合わせ導線の設計を実施。
     </p>
<div class="case-result">
<p class="case-result-label">
       RESULT — 問い合わせ数
      </p>
<p class="case-result-num" data-count="3.2" data-suffix="&lt;sup&gt;倍&lt;/sup&gt;">
       3.2
       <sup>
        倍
       </sup>
</p>
<p class="case-result-desc" style="font-size:16px;color:#28282D;">
       改善後3ヶ月で達成
      </p>
</div>
</div>
...
<p class="case-body">
      バラバラに運用していた
      <strong>
       SNS・Google広告・MEOを一つの戦略のもとに統合
      </strong>
      。各施策の役割を明確にし、相乗効果を生み出した。
     </p>
<div class="case-result">
<p class="case-result-label">
       RESULT — 月間来店数
      </p>
<p class="case-result-num" data-count="180" data-prefix="+" data-suffix="&lt;sup&gt;%&lt;/sup&gt;">
       +180
       <sup>
        %
       </sup>
...
<p class="case-body">
      広告依存の集客構造を分析。SEOとコンテンツ戦略を組み合わせることで、
      <strong>
       広告費を削減しながら安定した集客基盤を構築
      </strong>
      した。
     </p>
<div class="case-result">
...
<p class="case-result-num" data-count="52" data-prefix="-" data-suffix="&lt;sup&gt;%&lt;/sup&gt;">
       -52
       <sup>
        %
       </sup>
...
<span class="authority-eyebrow fu">
     TRACK RECORD
    </span>
...
<p class="authority-stat-n">
       200
       <sup>
        社+
       </sup>
</p>
<p class="authority-stat-l">
       累計支援実績
      </p>
</div>
<div class="authority-stat-other">
...
<span class="authority-tags-label fu">
     対応業種
    </span>
<div class="authority-tags fu" style="transition-delay:.1s">
<span class="authority-tag lg">
      医療・クリニック
     </span>
<span class="authority-tag lg">
      飲食・カフェ
...
<p class="faq-a-text">
       GA4・広告データ・競合分析などを用いて現状を数値化し、「なぜ成果が出ていないか」の根本原因を特定した上で、最も効果的な施策の組み合わせを設計するサービスです。「とりあえずSEO」ではなく、根拠のある優先順位で施策を選びます。
      </p>
</div>
</div>
</div>
...
<p class="faq-a-text">
       初回相談は完全無料です。戦略設計の費用はビジネスの規模や課題の複雑さによって異なります。まずは無料相談でご状況をお聴かせください。お見積りは無料でご提示します。
      </p>
</div>
</div>
</div>
...
<p class="faq-a-text">
       はい、医療・法律・教育・美容・飲食・ECなど２０業種以上の支援実績があります。業種によってWEBマーケティングの特性が異なるため、業種ごとの知見をもとに戦略を設計します。
      </p>
</div>
</div>
</div>
...
<p class="faq-a-text">
       はい、戦略設計のみのご依頼も承っています。「自社で実行したい」「現在の代理店に戦略だけ渡したい」など、様々なご要望に対応しています。まずはご相談ください。
      </p>
</div>
</div>
</div>
