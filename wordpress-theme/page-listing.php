...
<ol>
<li><a href="https://htmlacheive.com/">ホーム</a></li>
...
<!-- TARGETING: ターゲティング手法 -->
<section aria-labelledby="targeting-h2-listing" class="targeting-sec">
...
<div class="targeting-card-icon"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24"><circle cx="11" cy="11" r="8"></circle><line x1="21" x2="16.65" y1="21" y2="16.65"></line></svg></div>
...
<div class="targeting-card-icon"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><line x1="4.93" x2="19.07" y1="4.93" y2="19.07"></line></svg></div>
...
<div class="targeting-card-icon"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"></path><circle cx="12" cy="9" r="2.5"></circle></svg></div>
...
<div class="targeting-card-icon"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24"><rect height="20" rx="2" ry="2" width="14" x="5" y="2"></rect><line x1="12" x2="12.01" y1="18" y2="18"></line></svg></div>
...
<a class="seo-banner-btn" href="<?php echo esc_url( home_url( '/display/' ) ); ?>" style="background:#ffffff;color:#28282D;border-color:#ffffff;font-weight:700;font-size:14px;padding:0 28px;height:48px;">ディスプレイ広告ページを見る →</a>
</div>
</div>
<!-- FAQ -->
...
<!-- CHALLENGE（課題別コンパクト版） -->
<section aria-labelledby="challenge-h2-listing" class="challenge-sec">
...
<a class="view-all fu" href="<?php echo esc_url( home_url( '/column/listing/' ) ); ?>" style="transition-delay:.1s">すべて見る &rarr;</a>
</div>
<div class="blog-grid">
