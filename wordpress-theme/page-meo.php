...
<section id="voice" aria-labelledby="voice-title-meo" class="voice-sec">
  ...
  <div class="voice-grid">
    ...
    <article class="voice-card fu" style="transition-delay:.2s">
      <a href="<?php echo esc_url( home_url( '/voice-post/halpets-kobe/' ) ); ?>" class="voice-link" aria-label="ハルペッツ神戸の声を詳しく見る">
      <div class="voice-avatar">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/voice/harupets.webp" alt="ハルペッツ神戸" width="280" height="280" loading="lazy">
      </div>
      <div class="voice-body">
        <p class="voice-quote">
...
<a class="view-all fu" href="<?php echo esc_url( home_url( '/column/meo/' ) ); ?>" style="transition-delay:.1s">すべて見る &rarr;</a>
</div>
<div class="blog-grid">
