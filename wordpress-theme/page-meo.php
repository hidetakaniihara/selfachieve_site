...
<!-- OWN RESULT: 自社MEO実績 -->
<section aria-labelledby="meo-result-h2" class="own-result-sec">
...
<p class="sec-body fu" style="transition-delay:.15s;font-size:clamp(18px,2vw,26px);font-weight:700;line-height:1.6;letter-spacing:-.01em;color:#28282D;border-left:4px solid #28282D;padding-left:20px;margin-top:24px;">
...
<a class="btn-plan-h" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">無料相談を申し込む</a>
</div>
</div>
</div>
</section>
...
<!-- CHALLENGE（課題から探す） -->
<section aria-labelledby="challenge-h2-meo" class="challenge-sec" id="challenge">
...
<div class="blog-head">
<h2 class="blog-h2 fu" id="blog-h2">MEO関連コラム</h2>
<a class="view-all fu" href="<?php echo esc_url( home_url( '/column/' ) ); ?>" style="transition-delay:.1s">すべて見る</a>
</div>
<div class="blog-grid">
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/meo-basics/' ) ); ?>">
<span class="blog-cat">MEO BASICS</span>
<h3 class="blog-title">Googleマップで上位表示されるために最初にやるべき5つのこと</h3>
<p class="blog-date">2026.03.10</p>
</a>
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/gbp-optimization/' ) ); ?>" style="transition-delay:.1s">
...
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/review-management/' ) ); ?>" style="transition-delay:.2s">
