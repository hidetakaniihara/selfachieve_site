...
<header class="hd" role="banner">
  ...
  <nav class="hd-nav" aria-label="グローバルナビゲーション">
    <span class="hd-nav-item">
      ...
      <div class="hd-mega" role="menu">
        <div class="hd-mega-col">
          ...
          <a href="<?php echo esc_url( home_url( '/strategy/' ) ); ?>" role="menuitem"<?php if ( is_page('strategy') ) echo ' class="active"'; ?>>WEB戦略</a>
        ...
        <div class="hd-mega-col">
          ...
          <a href="<?php echo esc_url( home_url( '/seo/' ) ); ?>" role="menuitem"<?php if ( is_page('seo') ) echo ' class="active"'; ?>>SEO対策</a>
          <a href="<?php echo esc_url( home_url( '/meo/' ) ); ?>" role="menuitem"<?php if ( is_page('meo') ) echo ' class="active"'; ?>>MEO対策</a>
          ...
          <div class="hd-mega-accordion-sub">
            <a href="<?php echo esc_url( home_url( '/listing/' ) ); ?>" role="menuitem" class="hd-mega-sub-link<?php if ( is_page('listing') ) echo ' active'; ?>">リスティング広告</a>
            <a href="<?php echo esc_url( home_url( '/ads/display/' ) ); ?>" role="menuitem" class="hd-mega-sub-link<?php if ( is_page('display') ) echo ' active'; ?>">ディスプレイ広告</a>
          </div>
          <a href="<?php echo esc_url( home_url( '/sns/' ) ); ?>" role="menuitem"<?php if ( is_page('sns') ) echo ' class="active"'; ?>>SNSマーケティング</a>
          <a href="<?php echo esc_url( home_url( '/ai-seo/' ) ); ?>" role="menuitem"<?php if ( is_page('ai-seo') ) echo ' class="active"'; ?>>AI検索対策（LLM対策）</a>
          <a href="<?php echo esc_url( home_url( '/sns/note/' ) ); ?>" role="menuitem"<?php if ( is_page('note') ) echo ' class="active"'; ?>>note対策</a>
        </div>
        <div class="hd-mega-col">
          <span class="hd-mega-col-label"><span class="col-label-main">成約</span><span class="col-label-sub">（問い合わせ・売上を増やしたい）</span></span>
          <a href="<?php echo esc_url( home_url( '/website/' ) ); ?>" role="menuitem"<?php if ( is_page('website') ) echo ' class="active"'; ?>>ホームページ制作</a>
        ...
        <div class="hd-mega-col">
          ...
          <a href="<?php echo esc_url( home_url( '/ai-automation/' ) ); ?>" role="menuitem"<?php if ( is_page('ai-automation') ) echo ' class="active"'; ?>>業務の自動化・最適化</a>
        </div>
      </div>
      </div>
    </span>
    <span class="hd-nav-item">
      ...
      <div class="hd-mega" role="menu">
        <div class="hd-mega-col">
          ...
          <a href="<?php echo esc_url( home_url( '/strategy/' ) ); ?>" role="menuitem"<?php if ( is_page('strategy') ) echo ' class="active"'; ?>>WEB戦略設計</a>
          <a href="https://htmlacheive.com/saikatsu_r/" role="menuitem" target="_blank" rel="noopener noreferrer">採用戦略<svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:4px;opacity:.7"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></a>
        </div>
        <div class="hd-mega-col">
    ...
    <a href="<?php echo esc_url( home_url( '/works/' ) ); ?>" class="hd-nav-item<?php if ( is_post_type_archive('our_works') || is_singular('our_works') ) echo ' active'; ?>">実績</a>
    <a href="<?php echo esc_url( home_url( '/voice/' ) ); ?>" class="hd-nav-item<?php if ( is_post_type_archive('voice') || is_singular('voice') ) echo ' active'; ?>">お客さまの声</a>
    <span class="hd-nav-item<?php if ( is_page('company') ) echo ' active'; ?>">
      <a href="<?php echo esc_url( home_url( '/company/' ) ); ?>"<?php if ( is_page('company') ) echo ' aria-current="page"'; ?>>会社情報</a>
  ...
  <div class="hd-btns">
    ...
    <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="hd-btn<?php if ( is_page('contact') ) echo ' active'; ?>" aria-label="初回の相談無料">初回の相談無料</a>
  </div>
...
<div class="hd-drawer" id="hd-drawer" role="dialog" aria-label="モバイルメニュー">
  ...
  <nav class="hd-drawer-nav" aria-label="モバイルナビゲーション">
    ...
    <div class="hd-drawer-sub" aria-hidden="true">
      ...
      <a class="hd-drawer-link-item<?php if ( is_page('strategy') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/strategy/' ) ); ?>">WEB戦略</a>
      ...
      <a class="hd-drawer-link-item<?php if ( is_page('seo') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/seo/' ) ); ?>">SEO対策</a>
      <a class="hd-drawer-link-item<?php if ( is_page('meo') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/meo/' ) ); ?>">MEO対策</a>
      <a class="hd-drawer-link-item<?php if ( is_page('listing') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/listing/' ) ); ?>">リスティング広告</a>
      <a class="hd-drawer-link-item<?php if ( is_page('display') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/ads/display/' ) ); ?>">ディスプレイ広告</a>
      <a class="hd-drawer-link-item<?php if ( is_page('sns') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/sns/' ) ); ?>">SNSマーケティング</a>
      <a class="hd-drawer-link-item<?php if ( is_page('ai-seo') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/ai-seo/' ) ); ?>">AI検索対策（LLM対策）</a>
      <a class="hd-drawer-link-item<?php if ( is_page('note') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/sns/note/' ) ); ?>">note対策</a>
    ...
    <div class="hd-drawer-sub" aria-hidden="true">
      ...
      <a class="hd-drawer-link-item<?php if ( is_page('strategy') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/strategy/' ) ); ?>">WEB戦略設計</a>
      <a class="hd-drawer-link-item" href="https://htmlacheive.com/saikatsu_r/" target="_blank" rel="noopener noreferrer">採用戦略<svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:4px;opacity:.6"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></a>
    ...
    <!-- 実績（フラットリンク） -->
    <a class="hd-drawer-item<?php if ( is_post_type_archive('our_works') || is_singular('our_works') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/works/' ) ); ?>">実績</a>
    <!-- お客さまの声（フラットリンク） -->
    <a class="hd-drawer-item<?php if ( is_post_type_archive('voice') || is_singular('voice') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/voice/' ) ); ?>">お客さまの声</a>
    <!-- お知らせ（フラットリンク） -->
    <a class="hd-drawer-item<?php if ( is_post_type_archive('post') || is_singular('post') ) echo ' active'; ?>" href="<?php echo esc_url( home_url( '/news/' ) ); ?>">お知らせ</a>
    <!-- 会社情報（アコーディオン） -->
    <button class="hd-drawer-item hd-drawer-item--accordion<?php if ( is_page('company') ) echo ' active'; ?>" data-drawer-accordion aria-expanded="false">
      会社情報
      <svg class="hd-drawer-chevron" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
    </button>
    <div class="hd-drawer-sub" aria-hidden="true">
