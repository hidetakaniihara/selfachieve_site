<?php
/**
 * Template Name: コラム SEO基礎
 * page-columns-seo-basics.php
 */
get_header();
?>
<main>
...
<div class="article-wrap">
  ...
  <div class="article-body-wrap">
    ...
    <article class="article-content" id="article-content">
      ...
      <!-- h3 中見出し -->
      <h3 id="h3-1" class="fu" style="transition-delay:.05s">オーガニック検索と広告の違い</h3>
      ...
      <!-- 内部リンクボックス -->
      <a href="<?php echo esc_url( home_url( '/../listing/' ) ); ?>" class="related-link-box fu">
      ...
      <h3 id="h3-2" class="fu" style="transition-delay:.05s">Googleが重視する3つの評価軸</h3>
      ...
      <h2 id="h2-2" class="fu">2025年のSEO対策で押さえるべき最新トレンド</h2>

      <p>Googleのアルゴリズムは年々進化しており、2025年現在では特に以下の点が重要視されています。</p>

      <h3 id="h3-3" class="fu" style="transition-delay:.05s">E-E-A-T（経験・専門性・権威性・信頼性）の強化</h3>
      ...
      <h2 id="h2-3" class="fu">SEO対策の実践ステップ：今日からできる施策</h2>

      <p>SEO対策を効果的に進めるためには、正しい順序で取り組むことが重要です。以下の4ステップで進めましょう。</p>

      <h3 id="h3-5" class="fu" style="transition-delay:.05s">ステップ1：キーワード調査</h3>
      ...
      <h3 id="h3-6" class="fu" style="transition-delay:.05s">ステップ2：コンテンツ作成</h3>
      ...
      <h3 id="h3-7" class="fu" style="transition-delay:.05s">ステップ3：内部SEO対策</h3>
      ...
      <h2 id="h2-4" class="fu">よくある質問（FAQ）</h2>

      <div class="faq-item fu" itemscope itemtype="https://schema.org/Question">
      ...
      <div class="faq-item fu" style="transition-delay:.06s" itemscope itemtype="https://schema.org/Question">
        <div class="faq-q" role="button" tabindex="0" aria-expanded="false">
          <span class="faq-q-icon">Q</span>
      ...
      <div class="faq-item fu" style="transition-delay:.12s" itemscope itemtype="https://schema.org/Question">
        <div class="faq-q" role="button" tabindex="0" aria-expanded="false">
          <span class="faq-q-icon">Q</span>
