...
<div class="kv-inner">
<div class="kv-left">
<p class="kv-eyebrow fu">— ホームページ制作</p>
<h1 class="kv-h1 fu" id="kv-h1" style="transition-delay:.08s">
        WEB戦略に基づいた、<br/>
        結果の出るホームページ制作。
      </h1>
<p class="kv-sub fu" style="transition-delay:.16s">
        「作って終わり」のホームページ制作では、集客も問い合わせも増えません。セルフアチーブは戦略設計・企画・SEO・分析改善まで一貫して支援し、成果に直結するWEBサイトを制作します。
      </p>
</div>
</div>
</section>
...
<li><span aria-current="page">ホームページ制作</span></li>
</ol>
</nav>
<!-- WHY SA: なぜSAがいいか -->
...
<div class="why-inner">
<div class="why-head">
<span class="sec-eyebrow fu">BEYOND CREATION</span>
<h2 class="sec-h2 fu" id="why-h2" style="transition-delay:.1s">
        ただ作るだけでは、<br/>終わらない。
      </h2>
...
<div aria-hidden="true" class="why-card-icon">
<svg fill="none" height="18" stroke="#28282D" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24" width="18"><path d="M9 3H5a2 2 0 0 0-2 2v4"></path><path d="M9 3h6"></path><path d="M15 3h4a2 2 0 0 1 2 2v4"></path><path d="M3 9v6"></path><path d="M21 9v6"></path><path d="M3 15v2a2 2 0 0 0 2 2h4"></path><path d="M15 19h4a2 2 0 0 0 2-2v-2"></path><path d="M9 19h6"></path><line x1="12" x2="12" y1="8" y2="16"></line><line x1="8" x2="16" y1="12" y2="12"></line></svg>
</div>
<h3 class="why-card-title">WEB戦略設計から<br/>スタート</h3>
<p class="why-card-desc">「誰に・何を・どう伝えるか」を明確にしてから制作を開始。<strong>ターゲット設定・競合分析・キーワード戦略まで、戦略設計</strong>を制作の前段階として必ず行います。</p>
</div>
<div class="why-card fu" style="transition-delay:.08s">
<div class="why-card-num">02</div>
<div aria-hidden="true" class="why-card-icon">
<svg fill="none" height="18" stroke="#28282D" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24" width="18"><rect height="14" rx="2" width="20" x="2" y="3"></rect><path d="M8 21h8"></path><path d="M12 17v4"></path><path d="M7 8h4"></path><path d="M7 12h10"></path></svg>
</div>
<h3 class="why-card-title">企画・設計・<br/>コンテンツ制作</h3>
<p class="why-card-desc">サイト構成・ワイヤーフレーム・コピーライティングまで一貫対応。<strong>「何を伝えるか」のコンテンツ設計を重視</strong>し、訪問者が行動を起こしたくなるサイトを構築します。</p>
</div>
<div class="why-card fu" style="transition-delay:.16s">
<div class="why-card-num">03</div>
<div aria-hidden="true" class="why-card-icon">
<svg fill="none" height="18" stroke="#28282D" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24" width="18"><circle cx="11" cy="11" r="8"></circle><path d="M21 21l-4.35-4.35"></path><path d="M11 8v3l2 2"></path></svg>
</div>
<h3 class="why-card-title">SEO / LLMO設計を<br/>制作に組み込む</h3>
<p class="why-card-desc">制作段階からSEOを設計に組み込みます。タイトル・メタ情報・構造化データ・内部リンク・ページ速度まで、<strong>Googleに評価され、AIで紹介されるサイト構造を標準実装</strong>します。</p>
</div>
<div class="why-card fu" style="transition-delay:.24s">
<div class="why-card-num">04</div>
<div aria-hidden="true" class="why-card-icon">
<svg fill="none" height="18" stroke="#28282D" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24" width="18"><polyline points="3 17 8 12 13 15 21 6"></polyline><polyline points="17 6 21 6 21 10"></polyline></svg>
</div>
<h3 class="why-card-title">公開後の分析改善で<br/>成果を追求</h3>
<p class="why-card-desc">公開して終わりではなく、Googleアナリティクス・サーチコンソールによる<strong>データ分析・改善提案を継続</strong>。訪問者数・問い合わせ数の向上を数値で追いかけます。</p>
</div>
<!-- WHY WORKS SLIDER -->
<div class="why-works-slider">
...
<!-- MID CTA 1 -->
<section aria-labelledby="cta-mid1-h2" class="cta">
<div class="cta-wrap">
<p class="cta-eyebrow fu">FREE CONSULTATION</p>
<h2 class="cta-h2 fu" id="cta-mid1-h2" style="transition-delay:.1s">
...
<!-- WORKS: 制作事例 -->
<section aria-labelledby="works-title" id="works">
<div class="works-head">
<div>
<p class="sec-eyebrow fu">OUR WORKS</p>
<h2 class="sec-title-lg fu" id="works-title">数字で証明する、<br/>制作実績。</h2>
</div>
<a aria-label="制作実績をすべて見る" class="view-all fu" href="<?php echo esc_url( home_url( '/works/' ) ); ?>">すべて見る</a>
</div>
...
<span class="plan-phase-num">01</span>
<span class="plan-phase-label">MAKE — サイトを作る</span>
<span class="plan-phase-line"></span>
</div>
<div class="plan-grid">
<div class="plan-card is-featured fu">
<span aria-hidden="true" class="plan-icon"><svg fill="none" height="36" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 36 36" width="36"><rect height="22" rx="2" width="30" x="3" y="6"></rect><line x1="3" x2="33" y1="13" y2="13"></line><line x1="13" x2="23" y1="28" y2="28"></line><line x1="18" x2="18" y1="28" y2="33"></line><line x1="12" x2="24" y1="33" y2="33"></line></svg></span>
<span class="plan-type">WEBSITE</span>
<h3 class="plan-name">ホームページ制作</h3>
<p class="plan-tagline">戦略設計から制作・SEO・納品まで一貫対応。<br/>集客と問い合わせを最大化するサイトを構築。</p>
<div class="plan-divider"></div>
<ul class="plan-features">
<li class="plan-feature">WEB戦略設計・競合分析</li>
<li class="plan-feature">サイト構成・ワイヤーフレーム</li>
<li class="plan-feature">デザイン・コーディング</li>
<li class="plan-feature">SEO基礎設計（構造化データ含む）</li>
<li class="plan-feature">WordPress CMS構築</li>
<li class="plan-feature">Googleアナリティクス設定</li>
</ul>
<a class="btn-plan" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">無料相談を申し込む</a>
</div>
<div class="plan-card fu" style="transition-delay:.08s">
<span aria-hidden="true" class="plan-icon"><svg fill="none" height="36" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 36 36" width="36"><rect height="30" rx="2" width="24" x="6" y="3"></rect><line x1="11" x2="25" y1="11" y2="11"></line><line x1="11" x2="25" y1="17" y2="17"></line><line x1="11" x2="19" y1="23" y2="23"></line><polyline points="22,26 26,22 30,26"></polyline><line x1="26" x2="26" y1="22" y2="33"></line></svg></span>
<span class="plan-type">LANDING PAGE</span>
<h3 class="plan-name">LP制作</h3>
<p class="plan-tagline">広告・SNSからの流入を<br/>問い合わせ・購入に転換するLPを制作。</p>
<div class="plan-divider"></div>
<ul class="plan-features">
<li class="plan-feature">ターゲット・訴求設計</li>
<li class="plan-feature">コピーライティング</li>
<li class="plan-feature">デザイン・コーディング</li>
<li class="plan-feature">CVR最適化設計</li>
<li class="plan-feature">広告連携・タグ設定</li>
</ul>
<a class="btn-plan" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">無料相談を申し込む</a>
</div>
</div>
...
<!-- PHASE 2: 継続 -->
<div class="plan-group" id="grow">
<div class="plan-phase">
<span class="plan-phase-num">02</span>
<span class="plan-phase-label">GROW — 育てる・改善する</span>
<span class="plan-phase-line"></span>
</div>
<div class="plan-grid">
<div class="plan-card fu">
<span aria-hidden="true" class="plan-icon"><svg fill="none" height="36" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 36 36" width="36"><path d="M18 3L5 9v9c0 7.7 5.6 14.9 13 16.9C25.4 32.9 31 25.7 31 18V9L18 3z"></path><polyline points="12,18 16,22 24,14"></polyline></svg></span>
<span class="plan-type">MAINTENANCE</span>
<h3 class="plan-name">保守・運用サポート</h3>
<p class="plan-tagline">公開後のサーバー・CMS管理から<br/>コンテンツ更新代行まで対応。</p>
<div class="plan-divider"></div>
<ul class="plan-features">
<li class="plan-feature">サーバー・ドメイン管理</li>
<li class="plan-feature">WordPressアップデート</li>
<li class="plan-feature">コンテンツ更新代行</li>
<li class="plan-feature">セキュリティ対応</li>
<li class="plan-feature">バックアップ管理</li>
</ul>
<a class="btn-plan" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">無料相談を申し込む</a>
</div>
<div class="plan-card fu" style="transition-delay:.08s">
<span aria-hidden="true" class="plan-icon"><svg fill="none" height="36" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 36 36" width="36"><polyline points="4,28 12,18 18,22 26,12 32,16"></polyline><line x1="4" x2="32" y1="32" y2="32"></line><line x1="4" x2="4" y1="4" y2="32"></line></svg></span>
<span class="plan-type">ANALYTICS</span>
<h3 class="plan-name">分析改善</h3>
<p class="plan-tagline">データに基づいた継続的な改善で<br/>訪問者数・問い合わせ数を向上。</p>
<div class="plan-divider"></div>
<ul class="plan-features">
<li class="plan-feature">Googleアナリティクス分析</li>
<li class="plan-feature">サーチコンソール分析</li>
<li class="plan-feature">月次レポート作成</li>
<li class="plan-feature">改善提案・実施</li>
<li class="plan-feature">A/Bテスト設計・実施</li>
</ul>
<a class="btn-plan" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">無料相談を申し込む</a>
</div>
</div>
...
<!-- VOICE -->
<section aria-labelledby="voice-title-website" id="voice">
<div class="voice-head">
<div>
<p class="sec-eyebrow fu">CLIENT VOICES</p>
<h2 class="sec-title-lg fu" id="voice-title-website">伴走してきた企業の、<br/>リアルな声。</h2>
</div>
...
<section aria-labelledby="challenge-h2-website" class="challenge-sec">
<div class="challenge-split">
<!-- 左：見出しエリア -->
<div class="challenge-split-left">
<p class="sec-eyebrow fu">YOUR CHALLENGE</p>
<h2 class="sec-h2 fu" id="challenge-h2-website" style="transition-delay:.1s">
        あなたの課題は<br/>どれですか？
      </h2>
...
<span class="faq-q-text">ホームページ制作の費用はどのくらいかかりますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-1">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">制作するサイトの規模・機能・デザインの複雑さによって異なります。まずは無料相談にてご要望をお聞きし、最適なプランと費用をご提案します。小規模なコーポレートサイトから大規模なECサイトまで対応可能です。</p>
</div>
</div>
</div>
...
<span class="faq-q-mark">Q</span>
<span class="faq-q-text">制作期間はどのくらいかかりますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-2">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">一般的なコーポレートサイトで1〜2ヶ月、LP（ランディングページ）で2〜3週間が目安です。ただし、ページ数・機能・コンテンツの準備状況によって異なります。詳細はヒアリング後にお伝えします。</p>
</div>
</div>
</div>
...
<span class="faq-q-mark">Q</span>
<span class="faq-q-text">SEO対策は制作に含まれますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-3">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">はい、弊社のホームページ制作にはSEOの基礎設計（タイトル・メタ情報・構造化データ・ページ速度最適化など）が含まれます。さらに本格的なSEO対策をご希望の場合は、SEO対策サービスとの組み合わせをご提案します。</p>
</div>
</div>
</div>
...
<span class="faq-q-mark">Q</span>
<span class="faq-q-text">WordPressで制作してもらえますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-4">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">はい、WordPressでの制作に対応しています。お客様自身でコンテンツを更新・管理できるよう、使いやすいCMS環境を構築します。更新方法のレクチャーも行います。</p>
</div>
</div>
</div>
...
<span class="faq-q-mark">Q</span>
<span class="faq-q-text">制作後の保守・運用サポートはありますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-5">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">はい、制作後の保守・運用サポートプランをご用意しています。サーバー・ドメイン管理、WordPressのアップデート、コンテンツ更新代行、アクセス解析レポートなどを月額でサポートします。</p>
</div>
</div>
</div>
...
<span class="faq-q-mark">Q</span>
<span class="faq-q-text">既存サイトのリニューアルにも対応していますか？</span>
<span aria-hidden="true" class="faq-q-icon"></span>
</div>
<div class="faq-a" id="faq-a-6">
<div class="faq-a-inner">
<span class="faq-a-mark">A</span>
<p class="faq-a-text">はい、既存サイトのリニューアルにも対応しています。現状のサイトの課題分析から始め、SEO・デザイン・コンバージョン率の改善を目的としたリニューアル提案を行います。</p>
</div>
</div>
</div>
</div>
</section>
<section aria-labelledby="area-h2-website" class="area-sec" id="area">
<div class="area-inner">
<div class="area-left">
<p class="area-eyebrow fu">SERVICE AREA</p>
<h2 class="area-h2 fu" id="area-h2-website" style="transition-delay:.1s">
        対応エリア
      </h2>
...
<div class="blog-head">
<h2 class="blog-h2 fu" id="blog-h2">ホームページ制作 関連コラム</h2>
<a class="view-all fu" href="<?php echo esc_url( home_url( '/column/' ) ); ?>" style="transition-delay:.1s">すべて見る</a>
</div>
<div class="blog-grid">
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/website-seo/' ) ); ?>">
<span class="blog-cat">WEBSITE × SEO</span>
<h3 class="blog-title">集客できるホームページと集客できないホームページの違い——SEO設計の重要性</h3>
<p class="blog-date">2026.03.15</p>
</a>
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/website-cvr/' ) ); ?>" style="transition-delay:.1s">
<span class="blog-cat">CVR OPTIMIZATION</span>
<h3 class="blog-title">ホームページからの問い合わせを増やすCVR改善の5つのポイント</h3>
<p class="blog-date">2026.02.28</p>
</a>
<a class="blog-card fu" href="<?php echo esc_url( home_url( '/column/website-renewal/' ) ); ?>" style="transition-delay:.2s">
<span class="blog-cat">RENEWAL</span>
<h3 class="blog-title">ホームページリニューアルのタイミングと成功させるための準備——失敗しない進め方</h3>
<p class="blog-date">2026.02.10</p>
</a>
</div>
</div>
</section>
